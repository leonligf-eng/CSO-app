...
page_yield_v3 = st.Page("Yield_Report_v3.py", title="Yield Report_v3", icon="📈")
page_yield_v4 = st.Page("Yield_Report_v4.py", title="Yield Report_v4", icon="📈")
# 2. 把頁面綁定到導覽列
pg = st.navigation([page_planner, page_yield, page_yield_v2, page_yield_v3, page_yield_v4])
